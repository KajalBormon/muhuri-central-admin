        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_departure_reason_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Add Departure Reason</h2>
                    <!--end::Modal title-->

                    <!--begin::Close-->
                    <div id="kt_modal_add_departure_reason_close" data-bs-dismiss="modal" class="btn btn-icon btn-sm btn-active-icon-primary">
                ...
                <VForm @submit="submit()" :model="formData" ref="formRef">
                    ...
                    <div class="modal-footer flex-center">
                        <!--Discard Button-->
                        <button type="reset" id="kt_modal_add_departure_reason_cancel" class="btn btn-light me-3">
